...
//		Thread.sleep(5000);		
		...
		//Accounts -> GuestCustomers -> Add
		driver.findElement(By.xpath("//span[.='Accounts']")).click();
//		Thread.sleep(2000);
		driver.findElement(By.linkText("Guest Customers")).click();
//		Thread.sleep(4000);
		driver.findElement(By.xpath("//button[@type='submit']")).click();
//		Thread.sleep(4000);


		//Enter detail to create GuestCustomers
		...
		String sEmailId = "gc" + ts + "@gmail.com";
...
//		Thread.sleep(6000);
		...
		if (driver.findElement(By.xpath("//h4[text()='Changes Saved!']")).isDisplayed()){
			System.out.println("PASS: Successfully GuestCustomers created. 'Changes Saved!' displayed.");
		}else{
			System.out.println("FAIL: GuestCustomers NOT created. 'Changes Saved!' NOT displayed.");
		}
