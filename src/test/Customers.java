...
//		Thread.sleep(4000);
		...
		String sEmailId = "cust." + ts + "@gmail.com";
...
//		Thread.sleep(6000);
		...
		if (driver.findElement(By.xpath("//h4[text()='Changes Saved!']")).isDisplayed()){
			System.out.println("PASS: Successfully Customers created. 'Changes Saved!' displayed.");
		}else{
			System.out.println("FAIL: Customers NOT created. 'Changes Saved!' NOT displayed.");
		}
