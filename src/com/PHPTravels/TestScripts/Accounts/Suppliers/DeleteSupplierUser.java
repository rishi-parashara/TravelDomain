...
public class DeleteSupplierUser {
	...
	public void execute() {
		...
		int rowCount = ExcelReusableMethods.getRowCount(INPUT_PATH, "CreateSupplierUser");
		...
		for( i=1; i<=rowCount; i++){
			...
			ApplicationSpecificMethods.deleteUser(driver, "Suppliers", eId);			
			//Verify user delete
	...
	public static void main(String[] args) {
		...
		DeleteSupplierUser d = new DeleteSupplierUser();
		d.execute();
