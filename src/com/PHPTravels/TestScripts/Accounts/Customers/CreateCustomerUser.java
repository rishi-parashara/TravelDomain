package com.PHPTravels.TestScripts.Accounts.Customers;
...
public class CreateCustomerUser {
	...
	public void execute() {
		...
		int rowCount = ExcelReusableMethods.getRowCount(INPUT_PATH, "CreateCustomerUser");
		...
		for( i=1; i<=rowCount; i++){
			fn = ExcelReusableMethods.getCellValue(INPUT_PATH, "CreateCustomerUser", i, 0);
			ln = ExcelReusableMethods.getCellValue(INPUT_PATH, "CreateCustomerUser", i, 1);
			eId = ExcelReusableMethods.getCellValue(INPUT_PATH, "CreateCustomerUser", i, 2);
			uPw = ExcelReusableMethods.getCellValue(INPUT_PATH, "CreateCustomerUser", i, 3);
			cNo = ExcelReusableMethods.getCellValue(INPUT_PATH, "CreateCustomerUser", i, 4);

			//Create Customers User
			ApplicationSpecificMethods.createUser(driver, "Customers", fn, ln, eId, uPw, cNo);			
	...
	public static void main(String[] args) {
		...
		CreateCustomerUser c = new CreateCustomerUser();
		c.execute();
...
public static void main(String[] args) {
	...
	//Create Admin User
	ApplicationSpecificMethods.createUser(driver, "Customers");			
	//Verify the user creation
	ApplicationSpecificMethods.verifyChangesSaved(driver, "Created");
