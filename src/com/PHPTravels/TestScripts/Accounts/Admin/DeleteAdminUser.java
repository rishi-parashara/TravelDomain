...
public class DeleteAdminUser {
	...
	public void execute() {
		...
		int rowCount = ExcelReusableMethods.getRowCount(INPUT_PATH, "CreateUser");
		...
		for( i=1; i<=rowCount; i++){
			eId = ExcelReusableMethods.getCellValue(INPUT_PATH, "CreateUser", i, 2);

			//Delete Admin User
			ApplicationSpecificMethods.deleteUser(driver, "Admins", eId);			
			//Verify user delete
	...
	public static void main(String[] args) {
		...
		DeleteAdminUser d = new DeleteAdminUser();
		d.execute();
